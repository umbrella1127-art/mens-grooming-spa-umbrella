...
export const fallbackSettings: Settings = {
  ...
  business_hours_weekday: "火・金曜 17:00〜23:00",
  business_hours_weekend: "土・日・祝 10:00〜19:00",
  closed_days: "月・水・木曜",
...
export const fallbackMenus: Menu[] = [
  ...
  m({
    ...
    category: "head_spa_solo",
    description:
      "カットなしでご利用いただけるセットコースです。シェービングで肌を整え、ヘッドスパ「月」で頭をほぐし、ベーシックGRフェイシャルで肌までケア。通常価格12,100円のところ、10,450円でご利用いただけます。",
    price_yen: 10450,
    price_status: "fixed",
    price_note: "税込・カット不要",
    sort_order: 3,
  ...
  m({
    ...
    category: "shaving",
    description:
      "温かな蒸しタオルときめ細かな泡で肌を整え、顔から首元まで丁寧に仕上げます。単にヒゲを剃るのではなく、顔全体の清潔感を引き出すためのシェービングです。",
    price_status: "hidden",
  ...
  m({
    ...
    category: "option",
    description:
      "自分では確認しにくい鼻まわりまで整える、男性の身だしなみのためのオプションです。",
    duration_min: 10,
    price_yen: 990,
    price_status: "hidden",
    price_note: "オプション",
