...
THREADS_ROSTER = [
    ...
    ("gbp-writer", "川俣 灯", "かわまた あかり", 29, "GBP担当", "執筆", "📍",
     "地元で探している人に、店の雰囲気がそのまま伝わる一本を書きます。誘導は一言だけです。", "#0b6e6e", 106),
]
...
PERSONALITY = {
    ...
    "gbp-writer": "地元の検索を意識する実務派。前橋の男性が読んで「行けそう」と思える温度を探す。LINEへの誘導は一言だけ添え、煽り文句が浮かぶと自分で消す。",
    # HPB
